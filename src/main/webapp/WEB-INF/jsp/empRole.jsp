...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
  ...
  <style type="text/css">
  	#checkbox input{text-align:left;margin-left:100px;margin-top: 30px;}
  </style>
  
    <div class="main-content-inner" style="margin-top: 50px;">
	    <div class="container-fluid">
	    	<div class="row" style="margin-left: 100px;margin-top: 5px;">
	    		<h2><i class="fa fa-address-book-o" aria-hidden="true"></i>员工角色管理</h2>
	    	</div>
	    	<br/>
    		<div class="row">
			  <div class="col-md-4">
	...
	<div class="modal fade" id="shanchu_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	    ...
	    <form action="addEmpRole" method="post">
	        <div class="modal-content">
	            <div class="modal-header">
	                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
	                    <span aria-hidden="true">&times;</span></button>
	                <h4 class="modal-title" id="myModalLabel">员工角色</h4>
	            </div>
	            <div class="modal-body">
                    <div class="form-group" id="checkbox">
                    	<c:forEach var="c" items="${empRole}">
                    		<input type="checkbox" value="${c.id}"  name="checked" class="checkedId" />${c.name}
                    	</c:forEach>
                    </div>
	            </div>
	            <div class="modal-footer">
	            	<input type="hidden" value="" name="roleId" id="empId"/>
				...
				var id = $(this).next(".delid").val();
				 $.ajax({
		            ...
		            success: function (json) { 
						...
						$(".checkedId").each(function (index, c) {
